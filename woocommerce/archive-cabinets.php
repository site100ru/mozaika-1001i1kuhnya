      ...
      <div class="col text-light py-5">
        ...
        <div class="row py-0 py-md-2 mb-3 mb-md-4">
          <div class="col-md-6 col-lg-3 mb-3 mb-md-0">
            <div class="row align-items-center gx-3 gx-md-0">
              <div class="col-2 col-md-3">
                <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/icons/header-advantage-1.png"
                  class="img-fluid">
              </div>
          ...
          <div class="col-md-6 col-lg-3 mb-3 mb-md-0">
            <div class="row align-items-center gx-3 gx-md-0">
              <div class="col-2 col-md-3">
                <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/icons/header-advantage-2.png"
                  class="img-fluid">
              </div>
              <div class="col-10 col-md-9">
          ...
          <div class="col-md-6 col-lg-3 mb-3 mb-md-0">
            <div class="row align-items-center gx-3 gx-md-0">
              <div class="col-2 col-md-3">
                <img
                  src="<?php echo get_stylesheet_directory_uri(); ?>/images/icons/home-advantage-manufacture-icon.svg"
                  class="img-fluid">
              </div>
              <div class="col-10 col-md-9">
          ...
          <div class="col-md-6 col-lg-3 mb-0">
            <div class="row align-items-center gx-3 gx-md-0">
              <div class="col-2 col-md-3">
                <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/icons/home-advantage-discount-icon.svg"
                  class="img-fluid">
              </div>
              <div class="col-10 col-md-9">
        ...
        <p class="header-description text-light text-md-center mb-3 mb-md-4">Рассчитайте стоимость прямо сейчас за 10
          минут.</p>
...
<section class="archive-products-section site-section bg-white pb-5">
  <div class="container">
    ...
    <div class="row">
      <div class="col">
        <h2 class="text-uppercase text-center text-corporation-orange fw-bold mb-2">Каталог проектов для заказа шкафа по
          размерам</h2>
  ...
  <div class="container">
    ...
    <div class="row justify-content-center">
      <div class="col-md-9 py-5" style="position: relative;">
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/order-img-2.png" class="d-none d-md-block"
          style="max-width: 350px; position: absolute; bottom: 0; left: -50px;">
        <div class="row">
          <div class="col-md-7 offset-md-5 py-5 my-0 my-md-3 text-dark">
            ...
            <p class="mb-4"><strong>Бесплатно</strong> сделаем дизайн-проект и рассчитаем стоимость шкафа-купе прямо
              сейчас за 60 минут!</p>
            <button class="btn btn-lg btn-corporation-orange px-5 text-light" data-bs-toggle="modal"
...
<section class="process-section shkafy-cupe-section bg-white pt-5">
  <div class="container">
    <div class="row">
      <div class="col">
        <h2 class="text-uppercase text-center text-corporation-orange fw-bold mb-5">Заказать шкаф-купе по своим
          размерам<br>очень просто!</h2>
        <div class="row justify-content-center">
          <div class="col-md-4 mb-5">
            <div class="row">
              ...
              <div class="col-10">
                ...
                <p class="mb-0">Расскажите, какой шкаф-купе Вы хотите. При наличии ТЗ, набросок, картинок, размеров и
                  другой информации — присылайте нам на почту, в Whatsapp или Telegram.</p>
              </div>
            </div>
          </div>
          <div class="col-md-4 mb-5">
            <div class="row">
              ...
              <div class="col-10">
                ...
                <p class="mb-0">Бесплатно сделаем дизайн-проект шкафа-купе с пояснениями к нему и рассчитаем его
                  стоимость.</p>
              </div>
            </div>
          </div>
          <div class="col-md-4 mb-5">
            <div class="row">
              ...
              <div class="col-10">
                ...
                <p class="mb-0">Если Вам подходит наше предложение, к Вам приезжает наш специалист, производит замер,
                  утверждает сроки, материалы и заключает договор.</p>
              </div>
            </div>
          </div>
          <div class="col-md-4 mb-5">
    ...
    <div class="row justify-content-center">
      <div class="col-md-10 pt-3">
        ...
        <div id="carouselShkafCupePortfolio" class="carousel carousel-dark slide" data-bs-ride="carousel">
          ...
          <button class="carousel-control-prev" type="button" data-bs-target="#carouselShkafCupePortfolio"
            data-bs-slide="prev">
            <span class="carousel-control-prev-icon" style="height: 3.5rem;" aria-hidden="true"></span>
            <span class="visually-hidden">Previous</span>
          </button>
          <button class="carousel-control-next" type="button" data-bs-target="#carouselShkafCupePortfolio"
            data-bs-slide="next">
          ...
          <div class="col-md-6 mb-5">
            <div class="row">
              ...
              <div class="col-10">
                ...
                <p class="mb-0">Используем в работе МДФ, фанерованный шпоном разных пород дерева, МДФ, покрытый эмалью,
                  ЛДСП, алюминий, металл (сварные или сборные конструкции, покрытые порошковой краской), массив дерева.
                </p>
              </div>
            </div>
          </div>
...
<section id="quiz" class="py-5">
  <div class="container">
    <div class="row justify-content-center">
      <div class="col">
        <h2 class="text-uppercase text-center text-corporation-orange fw-bold">Ответьте на 6 вопросов ниже и узнайте
          предварительную стоимость Вашего шкафа</h2>
        <div class="title-line mb-5"></div>
        <div class="row justify-content-center">

          <!-- ВОПРОСЫ ПО ШКАФАМ -->
          <div class="col-12" id="2-2">
            <h3 class="text-center mb-5"><span class="me-2" style="color: #A5A5A5;">1/6</span>Какой тип шкафа Вам нужен?
            </h3>
              ...
              <div class="col-6 col-md-2">
                <label class="option_item mb-3" for="answer-2-2-1">
                  ...
                  <div class="option_inner">
                    ...
                    <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/quiz-new/2-2-1.jpg"
                      style="width: 100%;">
                  </div>
                </label>
              ...
              <div class="col-6 col-md-2">
                <label class="option_item mb-3" for="answer-2-2-2">
                  ...
                  <div class="option_inner">
                    ...
                    <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/quiz-new/2-2-2.jpg"
                      style="width: 100%;">
                  </div>
                </label>
              ...
              <div class="col-6 col-md-2">
                <label class="option_item mb-3" for="answer-2-2-3">
                  ...
                  <div class="option_inner">
                    ...
                    <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/quiz-new/2-2-3.jpg"
                      style="width: 100%;">
                  </div>
                </label>
              ...
              <div class="col-6 col-md-2">
                <label class="option_item mb-3" for="answer-2-2-4">
                  ...
                  <div class="option_inner">
                    ...
                    <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/quiz-new/2-2-4.jpg"
                      style="width: 100%;">
                  </div>
                </label>
              ...
              <div class="col-6 col-md-2">
                <label class="option_item mb-3" for="answer-2-2-5">
                  ...
                  <div class="option_inner">
                    ...
                    <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/quiz-new/2-2-5.jpg"
                      style="width: 100%;">
                  </div>
                </label>
              ...
              <div class="col-6 col-md-2">
                <label class="option_item mb-3" for="answer-2-2-6">
                  ...
                  <div class="option_inner">
                    ...
                    <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/quiz-new/2-2-6.jpg"
                      style="width: 100%;">
                  </div>
                </label>
            ...
            <div class="row justify-content-center">
              <div class="col text-center" style="margin-top: 35px;">
                <input type="button" value="Назад" class="btn btn-corporate-color-1-outline"
                  onclick="previousQuostion( '2-2' );">
          ...
          <div class="col-12" id="3-2" style="display: none;">
            <h3 class="text-center mb-5"><span class="me-2" style="color: #A5A5A5;">2/6</span>Какой материал фасада
              шкафа Вы хотите?</h3>
            <div class="row justify-content-md-center mb-5">
              <div class="col-6 col-md-2">
                <label class="option_item mb-3" for="answer-3-2-1">
                  ...
                  <div class="option_inner">
                    ...
                    <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/quiz-new/3-2-1.jpg"
                      style="width: 100%;">
                  </div>
                </label>
              ...
              <div class="col-6 col-md-2">
                <label class="option_item mb-3" for="answer-3-2-2">
                  ...
                  <div class="option_inner">
                    ...
                    <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/quiz-new/3-2-2.jpg"
                      style="width: 100%;">
                  </div>
                </label>
              ...
              <div class="col-6 col-md-2">
                <label class="option_item mb-3" for="answer-3-2-3">
                  ...
                  <div class="option_inner">
                    ...
                    <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/quiz-new/3-2-3.jpg"
                      style="width: 100%;">
                  </div>
                </label>
              ...
              <div class="col-6 col-md-2">
                <label class="option_item mb-3" for="answer-3-2-4">
                  ...
                  <div class="option_inner">
                    ...
                    <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/quiz-new/3-2-4.jpg"
                      style="width: 100%;">
                  </div>
                </label>
              ...
              <div class="col-6 col-md-2">
                <label class="option_item mb-3" for="answer-3-2-5">
                  ...
                  <div class="option_inner">
                    ...
                    <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/quiz-new/3-2-5.jpg"
                      style="width: 100%;">
                  </div>
                </label>
              ...
              <div class="col-6 col-md-2">
                <label class="option_item mb-3" for="answer-3-2-6">
                  ...
                  <div class="option_inner">
                    ...
                    <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/quiz-new/3-2-6.jpg"
                      style="width: 100%;">
                  </div>
                </label>
          ...
          <div class="col-12" id="4-2" style="display: none;">
            <h3 class="text-center mb-5"><span class="me-2" style="color: #A5A5A5;">3/6</span>Какая ориентировочная
              ширина шкафа планируется?</h3>
            <div class="row justify-content-md-center mb-5">
              <div class="col-3 col-md-1">
                <label class="option_item mb-3" for="answer-4-2-1">
                  ...
                  <div class="option_inner">
                    ...
                    <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/quiz-new/ico/check-background.svg"
                      style="width: 100%;">
                  </div>
                </label>
          ...
          <div class="col-12" id="5-2" style="display: none;">
            <h3 class="text-center mb-5"><span class="me-2" style="color: #A5A5A5;">4/6</span>Какое количество дверей Вы
              предполагаете?</h3>
            <div class="row justify-content-md-center mb-5">
              <div class="col-6 col-md-2">
                <label class="option_item mb-3" for="answer-5-2-1">
                  ...
                  <div class="option_inner">
                    ...
                    <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/quiz-new/5-2-1.jpg"
                      style="width: 100%;">
                  </div>
                </label>
              ...
              <div class="col-6 col-md-2">
                <label class="option_item mb-3" for="answer-5-2-2">
                  ...
                  <div class="option_inner">
                    ...
                    <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/quiz-new/5-2-2.jpg"
                      style="width: 100%;">
                  </div>
                </label>
              ...
              <div class="col-6 col-md-2">
                <label class="option_item mb-3" for="answer-5-2-3">
                  ...
                  <div class="option_inner">
                    ...
                    <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/quiz-new/5-2-3.jpg"
                      style="width: 100%;">
                  </div>
                </label>
              ...
              <div class="col-6 col-md-2">
                <label class="option_item mb-3" for="answer-5-2-4">
                  ...
                  <div class="option_inner">
                    ...
                    <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/quiz-new/5-2-4.jpg"
                      style="width: 100%;">
                  </div>
                </label>
              ...
              <div class="col-6 col-md-2">
                <label class="option_item mb-3" for="answer-5-2-5">
                  ...
                  <div class="option_inner">
                    ...
                    <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/quiz-new/5-2-5.jpg"
                      style="width: 100%;">
                  </div>
                </label>
              ...
              <div class="col-6 col-md-2">
                <label class="option_item mb-3" for="answer-5-2-6">
                  ...
                  <div class="option_inner">
                    ...
                    <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/quiz-new/5-2-6.jpg"
                      style="width: 100%;">
                  </div>
                </label>
          ...
          <div class="col-12" id="6-2" style="display: none;">
            <h3 class="text-center mb-5"><span class="me-2" style="color: #A5A5A5;">5/6</span>Какой подарок Вы хотите
              получить в случае заказа?</h3>
            <div class="row justify-content-md-center mb-5">
              <div class="col-6 col-md-2">
                <label class="option_item mb-3" for="answer-6-2-1">
                  ...
                  <div class="option_inner">
                    ...
                    <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/quiz-new/6-2-1.jpg"
                      style="width: 100%;">
                  </div>
                </label>
              ...
              <div class="col-6 col-md-2">
                <label class="option_item mb-3" for="answer-6-2-2">
                  ...
                  <div class="option_inner">
                    ...
                    <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/quiz-new/6-2-2.jpg"
                      style="width: 100%;">
                  </div>
                </label>
              ...
              <div class="col-6 col-md-2">
                <label class="option_item mb-3" for="answer-6-2-4">
                  ...
                  <div class="option_inner">
                    ...
                    <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/quiz-new/6-2-4.jpg"
                      style="width: 100%;">
                  </div>
                </label>
              ...
              <div class="row justify-content-center text-left quiz-content">
                <div class="col-md-3 col-6 pb-3">
                  <label class="form-check-label w-100" for="customRadioInline1" style="cursor: pointer;">
                    <div class="card border-0 bg-dark text-white">
                      <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/quiz/shkaf-kupe-v-prihojuyu.jpg"
                        class="card-img-top rounded" alt="Шкаф-купе в прихожую">
                      <div class="card-img-overlay pl-1 pr-1 d-flex align-items-end">
                        <div class="form-check">
                          <input class="form-check-input" type="radio" name="customRadioInline1"
                ...
                <div class="col-md-3 col-6 pb-3">
                  <label class="form-check-label w-100" for="customRadioInline2" style="cursor: pointer;">
                    <div class="card border-0 bg-dark text-white">
                      <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/quiz/shkaf-kupe-v-gostinuyu.jpg"
                        class="card-img-top rounded" alt="Шкаф-купе в гостиную">
                      <div class="card-img-overlay pl-1 pr-1 d-flex align-items-end">
                        <div class="form-check">
                          <input class="form-check-input" type="radio" name="customRadioInline1"
                ...
                <div class="col-md-3 col-6 pb-3">
                  <label class="form-check-label w-100" for="customRadioInline3" style="cursor: pointer;">
                    <div class="card border-0 bg-dark text-white">
                      <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/quiz/garderobnye.jpg"
                        class="card-img-top rounded" alt="Гардеробная">
                      <div class="card-img-overlay pl-1 pr-1 d-flex align-items-end">
                        <div class="form-check">
                          <input class="form-check-input" type="radio" name="customRadioInline1"
                ...
                <div class="col-md-3 col-6 pb-3">
                  <label class="form-check-label w-100" for="customRadioInline4" style="cursor: pointer;">
                    <div class="card border-0 bg-dark text-white">
                      <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/quiz/vstroyennye-shkafy-kupe.jpg"
                        class="card-img-top rounded" alt="Встроенный шкаф-купе">
                      <div class="card-img-overlay pl-1 pr-1 d-flex align-items-end">
                        <div class="form-check">
                          <input class="form-check-input" type="radio" name="customRadioInline1"
                ...
                <div class="col-md-3 col-6 pb-3">
                  <label class="form-check-label w-100" for="customRadioInline5" style="cursor: pointer;">
                    <div class="card border-0 bg-dark text-white">
                      <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/quiz/shkaf-kupe-v-spalnyu.jpg"
                        class="card-img-top rounded" alt="Шкаф-купе в спальню">
                      <div class="card-img-overlay pl-1 pr-1 d-flex align-items-end">
                        <div class="form-check">
                          <input class="form-check-input" type="radio" name="customRadioInline1"
                ...
                <div class="col-md-3 col-6 pb-3">
                  <label class="form-check-label w-100" for="customRadioInline6" style="cursor: pointer;">
                    <div class="card border-0 bg-dark text-white">
                      <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/quiz/uglovoy-shaf-kupe.jpg"
                        class="card-img-top rounded" alt="Угловой шкаф-купе">
                      <div class="card-img-overlay pl-1 pr-1 d-flex align-items-end">
                        <div class="form-check">
                          <input class="form-check-input" type="radio" name="customRadioInline1"
                ...
                <div class="col-md-3 col-6 pb-3">
                  <label class="form-check-label w-100" for="customRadioInline7" style="cursor: pointer;">
                    <div class="card border-0 bg-dark text-white">
                      <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/quiz/zerkalniy-shkaf-kupe.jpg"
                        class="card-img-top rounded" alt="Зеркальный шкаф-купе">
                      <div class="card-img-overlay pl-1 pr-1 d-flex align-items-end">
                        <div class="form-check">
                          <input class="form-check-input" type="radio" name="customRadioInline1"
                ...
                <div class="col-md-3 col-6 pb-3">
                  <label class="form-check-label w-100" for="customRadioInline8" style="cursor: pointer;">
                    <div class="card border-0 bg-dark text-white">
                      <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/quiz/korpusniy-shkaf-kupe.jpg"
                        class="card-img-top rounded" alt="Купейный шкаф-купе">
                      <div class="card-img-overlay pl-1 pr-1 d-flex align-items-end">
                        <div class="form-check">
                          <input class="form-check-input" type="radio" name="customRadioInline1"
