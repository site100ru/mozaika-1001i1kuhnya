			...
			<div class="col">
				...
				<div class="row justify-content-center">
					<div class="col-md-6 mt-5">
						<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/actions/action-1.webp" class="w-100 mb-4 rounded shadow">
						<p class="fs-5 fw-light">При заказе кухни - честная <strong>скидка &#160;5%!</strong> при 100% оплате.</p>
					</div>
					<div class="col-md-6 mt-5">
						<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/actions/action-melkaya-bytovay-technics.webp" class="w-100 mb-4 rounded shadow">
						<p class="fs-5 fw-light">При заказе кухни от 50 000 рублей - мелкая бытовая техника <strong>в&#160;подарок!</strong></p>
					</div>
					<div class="col-md-4 mt-5">
						<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/actions/action-5.webp" class="w-100 mb-4 rounded shadow">
						<p class="fs-5 fw-light">Нашим клиентам <strong>оплачиваем парковку</strong> в&#160;ТЦ&#160;"Малина"</p>
					</div>
					<div class="col-md-4 mt-5">
						<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/actions/action-4.webp" class="w-100 mb-4 rounded shadow">
						<p class="fs-5 fw-light">При заказе кухни <strong>скидка до&#160;35%!</strong></p>
					</div>
					<div class="col-md-4 mt-5">
						<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/actions/action-3.webp" class="w-100 mb-4 rounded shadow">
