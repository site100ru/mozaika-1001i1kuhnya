<?php
	...
	if ( $_POST['phone'] AND $_POST['answer6'] ) {
		...
		mail( "sidorov-vv3@mail.ru", "Заявка на расчет стоимости кухни с сайта 1001i1kuhnya.ru", "
			Имя: " . $name ."<br><br>
			Телефон: " . $phone ."<br><br>
		...
		$headers ); 	
		$_SESSION['win'] = 1;
		$_SESSION['recaptcha'] = '<p class="text-light">Спасибо за обращение в мебельный магазин «10011 и 1 кухня». Мы ответим Вам в&#160;ближайшее время.</p>';
